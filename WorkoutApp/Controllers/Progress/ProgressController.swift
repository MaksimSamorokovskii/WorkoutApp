...
class ProgressController: WABaseController {
    ...
    private let dailyPerformanceView = DeilyPerformanceView(with: R.Strings.Progress.dailyPerformance,
                                                            buttonTitle: R.Strings.Progress.last7Days)
    private let monthlyPerformanceView = MonthlyPerformaceView(with: R.Strings.Progress.monthlyPerformance,
